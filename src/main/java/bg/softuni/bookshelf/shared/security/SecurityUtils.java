package bg.softuni.bookshelf.shared.security;
 ...
 * Centralizes hashing logic to ensure consistency across the application.
 */
...
public final class SecurityUtils {
     ...
     * @throws IllegalStateException if the SHA-256 algorithm is unavailable (should not happen in a standard JVM).
     */
